        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-base sm:text-lg text-white/90 font-light">
              <p>
                Voyagez avec <span className="text-accent font-medium">élégance</span>, <span className="text-accent font-medium">confort</span> et <span className="text-accent font-medium">ponctualité</span> grâce à ELGOH, votre service de chauffeur privé à Paris et en Île-de-France.
              </p>
              <p>
