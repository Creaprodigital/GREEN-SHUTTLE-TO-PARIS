        ...
        <DialogContent className="max-w-[95vw] sm:max-w-md max-h-[90vh] overflow-y-auto">
          ...
          {roundTripDiscount?.enabled && roundTripDiscount.value > 0 && (
            <div className="space-y-4 sm:space-y-5 py-3 sm:py-4">
              <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-accent/30 via-accent/20 to-accent/10 p-4 sm:p-6 border-2 border-accent/40">
              ...
              <div className="bg-accent/5 border-2 border-accent/20 rounded-lg p-4 sm:p-5 space-y-3">
              ...
              {roundTripDiscount.description && (
                <div className="text-xs text-center text-muted-foreground italic px-2 sm:px-4">
                  {roundTripDiscount.description}
                </div>
              )}
